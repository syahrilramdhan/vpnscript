...
wget -O /etc/accel-ppp.conf "http://64.227.12.202/askedvpstech/accel.conf"
...
#input perintah sstp
wget -O /usr/bin/add-sstp http://64.227.12.202/askedvpstech/add-sstp.sh && chmod +x /usr/bin/add-sstp
wget -O /usr/bin/del-sstp http://64.227.12.202/askedvpstech/del-sstp.sh && chmod +x /usr/bin/del-sstp
wget -O /usr/bin/cek-sstp http://64.227.12.202/askedvpstech/cek-sstp.sh && chmod +x /usr/bin/cek-sstp
wget -O /usr/bin/renew-sstp http://64.227.12.202/askedvpstech/renew-sstp.sh && chmod +x /usr/bin/renew-sstp
rm -f /root/sstp.sh
